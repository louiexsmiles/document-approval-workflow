      ...
      <div className="flex items-end justify-between gap-4 border-b border-stone-100 px-5 py-6 sm:px-6">
        <div>
          ...
          <p className="page-subtitle">
            Each document moves through its own approval stages.
          </p>
        </div>
      ...
      {documents.length === 0 ? (
        <div className="flex flex-col items-center justify-center px-6 py-14 text-center">
          ...
          <p className="mt-1.5 max-w-sm text-sm text-stone-500">
            Create a document and build its approval workflow to get started.
          </p>
              ...
              >
                <div className="min-w-0">
                  ...
                  <div className="mt-1 text-sm text-stone-500">
                    {doc.currentStage ? doc.currentStage.name : 'No stages remaining'}
                  </div>
                </div>
